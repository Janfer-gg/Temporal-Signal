...
if __name__ == '__main__':
    with open('C:/Users/41518/Desktop/micro-全.csv', 'r', encoding='utf8')as aa:
        reader = csv.DictReader(aa)
        for line in reader:
            gRNA1 = line['gRNA1']
            if gRNA1 !='NA':
                Lindel1 = run(gRNA1, line['species'], 'C://Users//41518//Desktop//')
                line['lindel1']=Lindel1
            gRNA2 = line['gRNA2']
            if gRNA2 !='NA':
                Lindel2 = run(gRNA2, line['species'], 'C://Users//41518//Desktop//')
                line['lindel2'] = Lindel2

            with open('C:/Users/41518/Desktop/micro-1.csv','a',encoding='utf8',newline='') as f:
                writer = csv.writer(f)
