...
# 画图 ----------------------------------------------------------------------
{
  if (nrow(gRNA) != 0) {
    ...
    # g1_large<-get_large(t_Exon_region2,t_Exon_CDS2,gRNA[1,],"g1")
    # png(file = paste0(filepath,"//","gRNA_position_large2_1.png"),width = 480*3,height = 480*2,res = 72*2)
    # print(g1_large)
    # dev.off()
    # 
    # if(nrow(gRNA)>=2){
    #   g2_large<-get_large(t_Exon_region3,t_Exon_CDS3,gRNA[2,],"g2")
    #   png(file = paste0(filepath,"//","gRNA_position_large2_2.png"),width = 480*3,height = 480*2,res = 72*2)
    #   print(g2_large)
    #   dev.off()
    # }
    # if(nrow(gRNA)==3){
    #   g3_large<-get_large(t_Exon_region4,t_Exon_CDS4,gRNA[3,],"g3")
    #   png(file = paste0(filepath,"//","gRNA_position_large2_3.png"),width = 480*3,height = 480*2,res = 72*2)
    #   print(g3_large)
    #   dev.off()
    # }
