...
# 
filepath<-"C://Users//41518//Desktop//微生物//run3"
# dir.create(filepath)

gene.table<-read.csv("C://Users//41518//Desktop//微生物//micro3579-4500.csv")
...
for(i in 3579:4500){
  ...
  if(exists("gRNA")){
    ...
    write.csv(gene.table,"C://Users//41518//Desktop//微生物//micro3579-4500.csv",row.names = FALSE)
    rm(gRNA)
  }
}
