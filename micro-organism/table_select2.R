...
table_select2<-function(table){
  ...
  table1<-table[which(as.numeric(table$V1)>100 & as.numeric(table$V3)>=80 & as.numeric(table$V8)>=70 & table$V10=="0-0-0-0-0"),]
  if(nrow(table1)==0){
    table1<-table[which(as.numeric(table$V1)>=0 & as.numeric(table$V3)>=80 & as.numeric(table$V8)>=70 & table$V10=="0-0-0-0-0"),]
    if(nrow(table1)==0){
      table1<-table[which(as.numeric(table$V1)>100 & as.numeric(table$V3)>70 & as.numeric(table$V8)>60),]
      if(nrow(table1)==0){
        table1<-table[which(as.numeric(table$V1)>=0 & as.numeric(table$V3)>70 & as.numeric(table$V8)>60),]
      }
    }
  }
