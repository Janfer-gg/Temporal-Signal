primer_design1<-function(Gene,gRNA,Gene_rev,size,filepath){
  ...
  
  {
    ...
    if (Gene_rev) {
      ...
      write.csv(PCR.table_rev,paste0(filepath,"//PCR1.csv"),row.names = FALSE)
      source_python("OligoCalc.py")
      py$RunOligoCalc(paste0(filepath,"//PCR1.csv"),"C:\\Users\\41518\\Desktop\\work\\Ubigene\\primer\\chromedriver.exe")
      ...
      write.csv(PCR.table_fw,paste0(filepath,"//PCR2.csv"),row.names = FALSE)
      source_python("OligoCalc.py")
      py$RunOligoCalc(paste0(filepath,"//PCR2.csv"),"C:\\Users\\41518\\Desktop\\work\\Ubigene\\primer\\chromedriver.exe")
      
      primer_up<-read.csv(paste0(filepath,"//PCR1.csv"),header = TRUE)$PCR
      primer_down<-read.csv(paste0(filepath,"//PCR2.csv"),header = TRUE)$PCR
    ...
    # 正向基因 --------------------------------------------------------------------
      ...
      write.csv(PCR.table_fw,paste0(filepath,"//PCR1.csv"),row.names = FALSE)
      source_python("OligoCalc.py")
      py$RunOligoCalc(paste0(filepath,"//PCR1.csv"),"C:\\Users\\41518\\Desktop\\work\\Ubigene\\primer\\chromedriver.exe")
      ...
      write.csv(PCR.table_rev,paste0(filepath,"//PCR2.csv"),row.names = FALSE)
      source_python("OligoCalc.py")
      py$RunOligoCalc(paste0(filepath,"//PCR2.csv"),"C:\\Users\\41518\\Desktop\\work\\Ubigene\\primer\\chromedriver.exe")
